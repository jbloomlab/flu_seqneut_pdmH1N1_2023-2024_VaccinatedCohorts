...
## Quick summary
* The list of strains included in the library are listed in CSV format in [./data/viral_libraries/H1N1library_2023-2024_allStrains.csv](./data/viral_libraries/H1N1library_2023-2024_allStrains.csv), and the process of library design is described in [librarydesign/README.md](librarydesign/README.md). This panel of 59 circulating H1N1 viruses was selected in the late fall of 2023, including frequently observed and recently observed haplotypes from the Nextstrain tree build from 11-22-2023.
